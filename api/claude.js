/* ============================================================
   ...
   Vercel Serverless Function — pengganti api.php
   ============================================================ */
...
export default async function handler(req, res) {
  ...
  if (!messages || !Array.isArray(messages) || messages.length === 0) {
    return res.status(400).json({ error: { message: 'Messages tidak boleh kosong.' } });
  }
  ...
  try {
    ...
    return res.status(502).json({ error: { message: 'Gagal konek ke Claude API: ' + err.message } });
  }
}
